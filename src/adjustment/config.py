...
from src.utils.project_root import get_project_root as _get_project_root
from src.utils.schools.config_loader import (
    UNIVERSITY_DIFFICULTY_ORDER as _CFG_DIFFICULTY_ORDER,
)
...
TIER_RANK_REPAIR_MAX_ITER: int = 20
...
def _load_pipeline_config() -> dict:
    ...
    try:
        ...
        _logger.warning(
            "Failed to load pipeline_config.json, using hardcoded defaults",
            exc_info=True,
        )
    return {}
