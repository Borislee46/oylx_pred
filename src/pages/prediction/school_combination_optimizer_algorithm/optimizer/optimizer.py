...
class SchoolSelectionOptimizer:
    ...
    def _safe_execute(
        ...
        fallback_operation: Callable[[], Any] | None = None,
    ...
    def _run_optimization(self, problem: Any) -> Any | None:
    ...
    def _has_valid_recommendation(self, recommendation: dict[str, Any] | None) -> bool:
        ...
        if n_solutions == 0:
            ...
            if feasible_count == 0 and hasattr(result, "G") and result.G is not None:
                ...
                violations_info = ", ".join(
                    [
                        f"{name}={v:.2f}"
                        for name, v in zip(constraint_names, max_violations, strict=True)
                        if v > 0
                    ]
                )
    ...
    def optimize(
        ...
        gpa: float | None = None,
        major_category_cache: dict[str, str] | None = None,
        bg_target_similarity_cache: dict[str, Any] | None = None,
