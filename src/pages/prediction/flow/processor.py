...
from src.agent import get_boundary_case_agent
...
from src.pages.prediction.core.utils import cached_token_sort_ratio, denormalize_language_score
...
def _is_major_match(
    ...
    if sim >= COMBINATION_POOL_SEMANTIC_MIN:
        return True
    return cached_token_sort_ratio(bg_orig, m_lower) > COMBINATION_POOL_FUZZY_MIN
