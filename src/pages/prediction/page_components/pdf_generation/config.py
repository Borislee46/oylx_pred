...
class FontPathConfig:
    windows_fonts: List[str] = field(default_factory=lambda: [
    ...
    macos_fonts: List[str] = field(default_factory=lambda: [
        "/System/Library/Fonts/PingFang.ttc", 
        "/System/Library/Fonts/Helvetica.ttc",
        "/Library/Fonts/Arial Unicode MS.ttf",
    ])
    
    linux_fonts: List[str] = field(default_factory=lambda: [
...
class PDFContentConfig:
    strategy_descriptions: Dict[str, str] = field(default_factory=lambda: {
