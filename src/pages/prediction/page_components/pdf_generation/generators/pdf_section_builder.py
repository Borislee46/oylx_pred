...
class PDFSectionBuilder:
    ...
    def create_cover_page(self, user_nickname: str, report_title: str) -> List:
        ...
        left_aligned_body_style = ParagraphStyle(
            name="LeftBodyOnCover", parent=self.styles["CustomBody"], alignment=TA_LEFT
        )
    ...
    def create_background_section(self, user_data: Dict) -> List:
        ...
        try:
            ...
            radar_image.drawHeight = radar_image.drawHeight * (
                radar_image.drawWidth / radar_image.imageWidth
            )
        ...
        academic_data = [
            [
                ...
                Paragraph(user_data.get("background_university", "N/A"), self.styles["CustomBody"]),
            ],
            [
                Paragraph("<b>本科专业</b>", self.styles["CustomBody"]),
                Paragraph(user_data.get("background_major", "N/A"), self.styles["CustomBody"]),
            ],
            [
        ...
        left_aligned_body_style = ParagraphStyle(
            name="LeftBody", parent=self.styles["CustomBody"], alignment=TA_LEFT
        )
