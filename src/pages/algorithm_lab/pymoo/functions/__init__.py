...
from src.pages.algorithm_lab.pymoo.config import Config
...
class FunctionLoader:
    ...
    def __init__(self) -> None:
        ...
        if Config.warnings["not_compiled"] and not self.is_compiled:
            ...
            print("from src.pages.algorithm_lab.pymoo.config import Config")
...
def is_compiled():
    try:
        from src.pages.algorithm_lab.pymoo.functions.compiled.info import info
