...
from src.pages.algorithm_lab.pymoo.operators.crossover.binx import BinomialCrossover
from src.pages.algorithm_lab.pymoo.operators.mutation.nom import NoMutation
