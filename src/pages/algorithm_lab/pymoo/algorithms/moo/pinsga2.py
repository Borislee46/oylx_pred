...
from src.pages.algorithm_lab.pymoo.operators.survival.rank_and_crowding import RankAndCrowding
from src.pages.algorithm_lab.pymoo.termination.default import DefaultMultiObjectiveTermination
from src.pages.algorithm_lab.pymoo.util import value_functions as mvf
...
from src.pages.algorithm_lab.pymoo.util.reference_direction import select_points_with_maximum_distance
from src.pages.algorithm_lab.pymoo.util.vf_dominator import VFDominator
