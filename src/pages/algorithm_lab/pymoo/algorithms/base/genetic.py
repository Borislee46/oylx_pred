...
from src.pages.algorithm_lab.pymoo.core.duplicate import DefaultDuplicateElimination, NoDuplicateElimination
from src.pages.algorithm_lab.pymoo.core.initialization import Initialization
from src.pages.algorithm_lab.pymoo.core.mating import Mating
