...
export default function(component) {
  ...
  function init() {
    ...
    if (!doc.getElementById('hk-shield-v2-style')) {
      const style = doc.createElement('style');
      style.id = 'hk-shield-v2-style';
      style.textContent = __HK_SHIELD_CSS__;
...
HK_SHIELD_EFFECT_JS = HK_SHIELD_EFFECT_JS.replace(
    "__HK_SHIELD_CSS__",
    json.dumps(HK_SHIELD_EFFECT_CSS),
)
